...
#ifndef OBJECT_WRITABLE_INFORMATION
  #ifdef __GNUG__
...
#else
  #ifdef __GNUG__
    extern OBJECT_WRITABLE_INFORMATION_STRUCT ObjectWritableInformation[MAX_NR_OF_OBJECTS] EEPROMMEM;
  #else
    extern eeprom OBJECT_WRITABLE_INFORMATION_STRUCT ObjectWritableInformation[MAX_NR_OF_OBJECTS];
  #endif
#endif
