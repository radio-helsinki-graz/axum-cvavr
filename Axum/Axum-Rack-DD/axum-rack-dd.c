...
#include "Axum-Rack-DD.h"
#include "CANTransportLayer.h"
#include "Axum-Rack-DD-MambaNet.h"
// I2C Bus functions
#asm
...
void SetDIX4192s()
{
   ...
   for (cnt=0; cnt<4; cnt++)
   {
      ...
      i2c_write(0xE0+(cnt<<1));     //Chip address + write
      i2c_write(0x81); //   MAP -> auto increment + address 1
      i2c_write(0x3E); //01: PWD and Reset
      i2c_write(0x00); //02: (Read only) Global Interrupt Status
      i2c_write(0x20); //03: Port A Control Register 1
      i2c_write(0x01); //04: Port A Control Register 2
      i2c_write(0x28); //05: Port B Control Register 1
      i2c_write(0x05); //06: Port B Control Register 2
      ...
      i2c_write(0x1B); //0E: Receiver Control Register 2
