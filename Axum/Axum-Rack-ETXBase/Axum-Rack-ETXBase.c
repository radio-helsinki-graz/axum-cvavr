...
void main(void)
{
   ...
   // State7=1 State6=0 State5=0 State4=T State3=T State2=T State1=T State0=0
   PORTC=0x80;
   DDRC=0xE1;
   ...
   // State7=T State6=T State5=T State4=T State3=1 State2=1 State1=0 State0=T
   PORTE=0x0C;
   DDRE=0x0E;
