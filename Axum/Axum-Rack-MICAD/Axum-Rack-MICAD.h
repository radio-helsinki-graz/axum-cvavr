...
unsigned char MICClip[4];
unsigned char ADOverload[4];
...
unsigned char MICPhantom[4];
unsigned char MICPad[4];
unsigned char MICGain[4];
unsigned char InputStereoSelect[4];
unsigned char InputPhase[4];

unsigned char PGA2500Data[8];
