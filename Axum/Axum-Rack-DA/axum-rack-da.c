...
#include "Axum-Rack-DA.h"
#include "CANTransportLayer.h"
#include "Axum-Rack-DA-MambaNet.h"
...
void main(void)
{
   ...
   // State7=T State6=T State5=0 State4=1 State3=1 State2=T State1=T State0=T
   PORTD=0x10;
   DDRD=0x38;
   ...
   for (cntByte=0; cntByte<8; cntByte++)
   {
      ...
      SetOutputRoutingAndLevel(cntByte);
   }
               ...
               {  //Line-out routing
                  ...
                  if (DataType == STATE_DATATYPE)
                  {
                     if (DataSize == 1)
                     {
                        ...
                        SetOutputRoutingAndLevel(ChannelNr);
               ...
               {  //Line-out talkback
                  ...
                  if (DataType == STATE_DATATYPE)
                  {
                     if (DataSize == 1)
                     {
                        ...
                        SetOutputRoutingAndLevel(OutputNr<<1);
...
void SetOutputRoutingAndLevel(unsigned char ChannelNr)
{
